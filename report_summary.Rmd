...
modal_age_range <- range(ad_long$modal_age, na.rm = TRUE)
# Table caption
...
# Output table
plot_growth(dist, ad_long, strata = config$strata)
```
...
# Output table
pander(style_table1(get(vsname("num_read_tab", stratum))), missing = "-")
...
# Output table
pander(style_table2(get(vsname("cv_tab", stratum))), missing = "-")
...
# Output table
pander(style_table2(get(vsname("pa_tab", stratum))), missing = "-")
