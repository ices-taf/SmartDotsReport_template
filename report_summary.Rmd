...
# Output table
pander(style_table1(num_read_tab_ex[,colnames(num_read_tab_ex) %in% c("Modal age", "total")]), missing = "-")
...
# Output table
pander(style_table1(cv_tab_ex[,colnames(cv_tab_ex) %in% c("Modal age", "all")]), missing = "-")
...
# Output table
pander(style_table1(pa_tab_ex[,colnames(pa_tab_ex) %in% c("Modal age", "total")]), missing = "-")
...
# Output table
pander(style_table1(ape_tab_ex[,colnames(ape_tab_ex) %in% c("Modal age", "all")]), missing = "-")
...
# Output table
pander(style_table1(rel_bias_tab_ex[,colnames(rel_bias_tab_ex) %in% c("Modal age", "all")]), missing = "-")
...
# Table caption
  ...
  set.caption(cap_i)
  pander(style_table3(ae_mat_ex[[1]]), missing = "-")
