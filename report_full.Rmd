...
is `r round(summary_statistics[2],1)`%, with an overall CV of `r round(summary_statistics[1],1)`%.
The APE is `r round(summary_statistics[3],1)`%.
...
# Output figure
plot_growth(dist, ad_long_all, params$strata)
```
...
# Output table
plot_growth(dist, ad_long_ex, params$strata)
